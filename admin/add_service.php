    ...
    <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="category" id="category" class="select2-enhanced" required>
                    ...
                    <?php foreach ($categories as $category): ?>
                        <option value="<?php echo htmlspecialchars($category['name']); ?>" <?php echo (isset($_POST['category']) && $_POST['category'] === $category['name']) ? 'selected' : ''; ?>>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="number" name="duration_minutes" id="duration_minutes" min="15" step="15" value="<?php echo htmlspecialchars($_POST['duration_minutes'] ?? '60'); ?>" required>
            </div>
            
            <div class="form-group">
                <label for="is_active" class="checkbox-label">
                    <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo (isset($_POST['is_active']) && $_POST['is_active']) ? 'checked' : ''; ?>>
                    Active Service
                </label>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="description" rows="5" placeholder="Describe the service, what's included, and any special notes..."><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
        </div>
