...
if (isset($_GET['debug'])) {
    ...
    echo "Is Admin: " . (isset($_SESSION['is_admin']) && $_SESSION['is_admin'] == 1 ? 'Yes' : 'No') . "<br>";
...
if (isset($_GET['debug'])) {
    ...
    echo "Connection status: " . (isset($conn) ? 'Connected' : 'Not connected') . "<br>";
    if (isset($conn)) {
        echo "Connection error: " . ($conn->connect_error ?? 'None') . "<br>";
    }
    echo "</div>";
}
