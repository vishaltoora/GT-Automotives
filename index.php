...
<body>
    ...
    <section class="hero" style="background-color: #243c55;">
        <div class="hero-content">
            ...
            <a href="products.php" class="btn">Browse Tires</a>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p>Professional tire installation by certified technicians</p>
                </div>
                <div class="feature-card">
                    <i class="fas fa-truck"></i>
                    <h3>Fast Service</h3>
                    <p>Quick and efficient tire replacement service</p>
                </div>
                <div class="feature-card">
